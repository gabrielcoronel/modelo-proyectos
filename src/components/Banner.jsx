    ...
    <>
      <div className="flex justify-between items-center w-full py-4 px-3 bg-primary shadow-2xl shadow-primary">
        ...
        <span
          {...hoveringEvents}
          className={
            `flex items-center gap-x-2 text-base text-background cursor-pointer transition-all ease-in-out delay-150 duration-300 ${isHovering ? "-translate-y-1 scale-105 font-bold" : ""}`
          }
